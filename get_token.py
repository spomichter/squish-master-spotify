...
def main():
    ...
    auth_spotify = "https://accounts.spotify.com/authorize?response_type=code&redirect_uri=http://localhost:8080/spotify&client_id={}&scope=user-read-private%20user-read-email%20user-library-read%20user-top-read%20playlist-modify-public%20user-follow-read%20user-read-playback-state%20user-modify-playback-state%20user-read-recently-played%20playlist-modify-private%20user-follow-modify%20user-read-currently-playing%20playlist-read-collaborative%20user-library-modify%20playlist-read-private&state={}" \
        .format(CLIENT_ID, secret)

    #auth_spotify = "https://accounts.spotify.com/authorize?response_type=code&redirect_uri=http://localhost:8080/spotify&client_id={}&scope=user-read-private&state={}" \
        #.format(CLIENT_ID, secret)
